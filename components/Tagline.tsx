...
const Tagline = () => {
  return (
    <section className='h-96 flex items-center justify-center flex-col gap-10 mb-10'>
      <h1 className='w-1/2 text-xl font-normal text-center tracking-wide font-lato '>
