...
const Tagline = () => {
  return (
    <section className='h-96 flex items-center justify-center flex-col gap-10 mb-10 lg:mt-0 mt-10'>
      <h1 className='lg:w-1/2 px-4 lg:px-0 text-xl font-normal text-justify lg:text-center tracking-wide font-lato '>
