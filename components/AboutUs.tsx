...
const AboutUs = () => {
  return (
    <section id='about' className='h-[80dvh] lg:mt-0 mt-50 flex items-center justify-center flex-col gap-10 w-full'>
        <article className='flex items-center justify-center flex-col gap-2 px-8'>
        ...
        <aside className='flex items-center lg:flex-row flex-col gap-5 px-8'>
