  ...
  return (
    <section id='about' className='h-[80dvh] flex items-center justify-center flex-col gap-10'>
        ...
        <aside className='flex items-center gap-x-5'>
            <article className='p-4 rounded-lg border border-black max-w-[30dvw] space-y-3'>
        ...
        <p className='text-lg italic font-medium tracking-tight'>Join us in making a difference—one meal at a time. Download the FoodSaver app today and be part of the food waste revolution!</p>
    </section>
  )
}
